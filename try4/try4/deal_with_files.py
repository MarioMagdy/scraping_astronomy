...
def save_txt2(file_and_dir,file):
    text_file = open(file_and_dir, "w",encoding='UTF-8')
    text_file.write('Hello World.'+'<br>.'*10 +file)
    text_file.close()
...
# def save_htm2(file_and_dir,file):
#     text_file = open(file_and_dir,  'wb+',encoding='UTF-8')
...
# script = read_script(r'try4\scripts\scripts_10.htm')

# save_txt2('newscript.htm',script)